...
class JWTServiceTest {
    ...
    @Test
    fun `generateJWTToken should produce a valid, signed compact JWT string`() = runTest {
    ...
    @Test
    fun `validateTokenAndGetSubject should return correct subject when token is valid`() = runTest {
    ...
    @Test
    fun `validateTokenAndGetSubject should throw JWTException when signature is invalid`() = runTest {
    ...
    @Test
    fun `validateTokenAndGetSubject should throw JWTException when issuer mismatches`() = runTest {
        val algorithm = Algorithm.HMAC256(testSecret)
        val badIssuerToken = JWT.create()
